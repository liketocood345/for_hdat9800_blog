...
**Takeaways:** a fused domain skill ([`ggplot-hourglass`](#ggplot-hourglass-skill)) and an [`hourglass-skill-merge-skill`](#hourglass-skill-merge-skill). You get a maintainer-facing map of triggers, BIND decisions, and leaf pointers, plus an honest read on **Merged vs Linked** and when the architecture is worth the cost.
...
```{=html}
<span id="ggplot-hourglass-skill"></span>
<span id="hourglass-skill-merge-skill"></span>
```

| Artifact | Role |
|----------|------|
| [`ggplot-hourglass/SKILL.md`](#ggplot-hourglass-skill) | Thin fused entry—one funnel, not four parallel loads |
| [`hourglass-skill-merge-skill/SKILL.md`](#hourglass-skill-merge-skill) | Meta skill—hourglass merge for any conflicting set |
